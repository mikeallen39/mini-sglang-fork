...
from minisgl.fla_vendor.index import prepare_chunk_indices
from minisgl.fla_vendor.op import safe_exp
from minisgl.fla_vendor.utils import autotune_cache_kwargs
from minisgl.fla_vendor.wy_fast import recompute_w_u_fwd

# Avoid import-time CUDA capability probing. Use conservative IEEE precision.
