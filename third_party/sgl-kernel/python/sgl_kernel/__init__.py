...
_MOE_ROUTING_ONLY = hasattr(torch.ops.sgl_kernel, "moe_align_block_size") and not hasattr(
...
if not _MOE_ROUTING_ONLY:
    ...
    try:
        ...
        es_fp8_blockwise_scaled_grouped_mm = None
        es_sm100_mxfp8_blockscaled_grouped_mm = None
        es_sm100_mxfp8_blockscaled_grouped_quant = None
...
def create_greenctx_stream_by_value(*args, **kwargs):
    if _MOE_ROUTING_ONLY:
        raise RuntimeError("sgl_kernel was built in moe-routing-only mode")
